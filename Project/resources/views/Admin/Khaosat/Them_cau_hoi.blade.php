...
@section('headercontent')
    <div class="content-header">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li><a href="{{route('sinhvien/xem',$data_sinhvien[0]->student_code)}}"><i class="fa  fa-user-plus"></i>Xem
            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 style="color: darkblue;font-weight: bold; text-align: center">Xem thông tin sinh
                            viên</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal">
                        <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="family_phone" type="text" class="form-control"
                                                   ...
                                                   value="{{$data_sinhvien['0']->family_phone}}" readonly>
                                        </div>
                                    </div>
                                    <!--Điện thoại cá nhân -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="personal_phone" type="text" class="form-control"
                                                   ...
                                                   value="{{$data_sinhvien['0']->personal_phone}}" readonly>
                                        </div>
                                    </div>
                                    <!-- Email -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" id="email"
                                                   value="{{$data_sinhvien['0']->email}}" readonly>
                                        </div>
                                    </div>
                                    <!-- Địa chỉ-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="family_address"
                                                   value="{{$data_sinhvien['0']->family_address}}" readonly>
                                        </div>
                                    </div>
                                    <!-- Địa chỉ-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="current_address"
                                                   value="{{$data_sinhvien['0']->current_address}}" readonly>
                                        </div>
                                    </div>
                                    {{--<!-- Quận/Huyện-->--}}
                                    {{--<div class="form-group">--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="status" name="status"
                                                   value="{{$data_sinhvien['0']->status}}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   value="{{$data_sinhvien['0']->reason}}" readonly>
                                        </div>
                                    </div>
                                    <!-- End form left   -->
                                </div>
                            ...
                            <div class="box-footer">
                                ...
                                {{--</button>--}}
                                <a class="btn btn-primary pull-right" href="{{route('sinhvien/index_sv')}}">Thoát</a>
                            </div>
                            <!-- /.box-footer -->
                        </div>
