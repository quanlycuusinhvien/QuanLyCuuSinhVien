...
@section('headercontent')
    <div class="content-header">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li><a href="{{route('cuusinhvien/sua',$data_cuusinhvien[0]->student_code)}}"><i class="fa  fa-info"></i>Chỉnh
                    sửa thông tin cựu sinh viên</a></li>
        </ol>
    </div>
@endsection
@section('bodycontent')
            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 style="color: darkblue;font-weight: bold; text-align: center">Chỉnh sửa thông tin cựu sinh
                            viên</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="box-body" style="min-width: 90%">
                                        <div class="form-group">
                                            ...
                                            <table id="sua" class="table table-bordered table-striped"
