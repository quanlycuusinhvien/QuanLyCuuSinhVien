...
@section('headercontent')
    <div class="content-header">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li><a href="{{route('cuusinhvien/index_csv')}}"><i class="fa fa-graduation-cap"></i>Quản lý cựu sinh
                    viên</a>
            </li>
            <li><a href="{{route('cuusinhvien/xem',$data_cuusinhvien[0]->student_code)}}"><i class="fa  fa-info"></i>Xem
                    thông tin cựu sinh viên</a></li>
        </ol>
    </div>
@endsection
@section('bodycontent')
            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 style="color: darkblue;font-weight: bold; text-align: center">Xem thông tin cựu sinh
                            viên</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                        ...
                        <div class="box-body">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="student_code"
                                                   name="student_code"
                                                   value="{{$data_cuusinhvien[0]->student_code}}" readonly>
                                        </div>
                                    </div>
                                    <!-- Tên sinh viên -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fullname" name="fullname"
                                                   value="{{$data_cuusinhvien[0]->fullname}}" readonly>
                                        </div>
                                    </div>
                                    <!-- Email -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" id="student_email"
                                                   value="{{$data_cuusinhvien['0']->student_email}}" readonly>
                                        </div>
                                    </div>
                                    <!-- Phái -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="gender"
                                                   value="{{$data_cuusinhvien['0']->gender}}" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="date_of_birth"
                                                   name="date_of_birth"
                                                   value="{{$data_cuusinhvien['0']->date_of_birth}}" readonly>
                                        </div>
                                    </div>
                                    <!-- Dân tộc-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="minority_name"
                                                   name="minority_name"
                                                   value="{{$data_cuusinhvien['0']->minority_name}}" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="family_phone" type="text" class="form-control"
                                                   ...
                                                   value="{{$data_cuusinhvien['0']->family_phone}}" readonly>
                                        </div>
                                    </div>
                                    <!--Điện thoại cá nhân -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="personal_phone" type="text" class="form-control"
                                                   ...
                                                   value="{{$data_cuusinhvien['0']->personal_phone}}" readonly>
                                        </div>
                                    </div>
                                    <!-- Email -->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" id="email"
                                                   value="{{$data_cuusinhvien['0']->email}}" readonly>
                                        </div>
                                    </div>
                                    <!-- Địa chỉ-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="family_address"
                                                   value="{{$data_cuusinhvien['0']->family_address}}" readonly>
                                        </div>
                                    </div>
                                    <!-- Địa chỉ-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="current_address"
                                                   value="{{$data_cuusinhvien['0']->current_address}}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="homeroom_code"
                                                   name="homeroom_code"
                                                   value="{{$data_cuusinhvien['0']->homeroom_code}}" readonly>
                                        </div>
                                    </div>
                                    <!--Tên lớp-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="homeroom_name"
                                                   name="homeroom_name"
                                                   value="{{$data_cuusinhvien['0']->homeroom_name}}" readonly>
                                        </div>
                                    </div>
                                    <!--Mã chuyên ngành-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="speciality_code"
                                                   ...
                                                   value="{{$data_cuusinhvien['0']->speciality_code}}" readonly>
                                        </div>
                                    </div>
                                    <!--Tên chuyên ngành-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="speciality_name"
                                                   ...
                                                   value="{{$data_cuusinhvien['0']->speciality_name}}" readonly>
                                        </div>
                                    </div>
                                    <!--Mã ngành-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="major_code" name="major_code"
                                                   value="{{$data_cuusinhvien['0']->major_code}}" readonly>
                                        </div>
                                    </div>
                                    <!-- Tên ngành-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="major_name" name="major_name"
                                                   value="{{$data_cuusinhvien['0']->major_name}}" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="college_code"
                                                   name="college_code"
                                                   value="{{$data_cuusinhvien['0']->college_code}}" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="college_name"
                                                   name="college_name"
                                                   value="{{$data_cuusinhvien['0']->college_name}}" readonly>
                                        </div>
                                    </div>
                                    {{-- --}}
                                    <h4 class="box-title" style="color: darkblue;font-weight: bold; text-align: center">
                                        Trạng Thái của cựu sinh viên
                                    </h4>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="status" name="status"
                                                   value="{{$data_cuusinhvien['0']->status}}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   value="{{$data_cuusinhvien['0']->reason}}" readonly>
                                        </div>
                                    </div>
                                    {{--<!-- Quận/Huyện-->--}}
                                    {{--<div class="form-group">--}}
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="status" class="col-sm-3 control-label">Quyết định tốt nghiệp</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="status" name="status"
                                                   readonly>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Ngày ký</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly>
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Học kỳ tốt nghiệp</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly>
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Niên khóa tốt nghiệp</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly >
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Tính chỉ tích lũy</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly >
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Điểm trung bình Tích
                                            lũy</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Điểm rèn luyện</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly >
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Xếp Loại</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly  >
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Danh Hiệu</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly>
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">AUN</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly>
                                ...
                                <div class="col-sm-6">
                                    <div class="box-body" style="min-width: 90%">
                                        <div class="form-group" >
                                            <h4 class="box-title"
                                                style="color: darkblue;font-weight: bold; text-align: center">
                                                Thông Tin Việc làm
                                            </h4>
                                            <table id="xem" class="table table-bordered table-striped" style="font-size: 11px;">
                                                <thead>
                                                <tr>
                                                    <th>Trạng thái</th>
                                                    <th>Đúng chuyên ngành</th>
                                                    <th>Thời gian bắt đầu</th>
                                                    <th>Thời gian Kêt thúc</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td>
                                                        {{--<button class="btn btn-sm btn-warning pull-right">Xem</button>--}}
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Vị trí làm việc</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly >
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Mức lương</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly>
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Tên công ty</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly>
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Địa chỉ công ty</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly>
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Thời gian bắt đầu</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly >
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Thời gian kết thúc</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                                   readonly>
                            ...
                            <div class="box-footer">
                                ...
                                <a class="btn btn-primary pull-right"
                                   href="{{route('cuusinhvien/index_csv')}}">Thoát</a>
                            </div>
                            <!-- /.box-footer -->
                        </div>
