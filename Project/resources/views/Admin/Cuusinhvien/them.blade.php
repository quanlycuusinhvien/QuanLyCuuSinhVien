...
@section('headercontent')
    <div class="content-header">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li><a href="{{route('cuusinhvien/them')}}"><i class="fa  fa-user-plus"></i>Thêm cựu sinh viên</a></li>
        </ol>
    </div>
@endsection
@section('bodycontent')
            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 style="color: darkblue;font-weight: bold; text-align: center">Thêm Cựu Sinh Viên</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="student_code" class="col-sm-3 control-label">Mã cựu sinh
                                            viên</label>
                                        <div class="col-sm-9">
                                    ...
                                    <!-- Tên sinh viên -->
                                    <div class="form-group">
                                        <label for="fullname" class="col-sm-3 control-label">Tên tên sinh viên</label>
                                        <div class="col-sm-9">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="reason" class="col-sm-3 control-label">Tình trạng việc làm</label>
                                        <div class="col-sm-9">
                                            <input type="Text" class="form-control" id="reason"
                                                   name="reason"
                                            >
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-success pull-right"
                                    ...
                                    <i class="fa fa-user pull-left "></i>Thêm mới
                                </button>
                                <a class="btn btn-warning pull-right" href="{{route('cuusinhvien/index_csv')}}">Thoát</a>
                            </div>
                            <!-- /.box-footer -->
                        </div>
